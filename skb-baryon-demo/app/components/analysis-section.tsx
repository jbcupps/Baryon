        ...
        <CardContent>
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-700 leading-relaxed">
              The SKB hypothesis provides quantitative predictions for particle properties through 
              topological mathematics. Below are detailed analyses showing how holonomy, flux 
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 border rounded-lg space-y-2">
                  <h5 className="font-semibold text-purple-800">SKB Integration</h5>
                  <ul className="text-sm space-y-1 text-slate-700">
            ...
            <div className="p-4 bg-amber-50 rounded-lg">
              <h4 className="font-semibold text-amber-800 mb-2">SKB-QCD Mathematical Connection</h4>
              <p className="text-sm text-amber-700 mb-3">
                The SKB hypothesis provides a topological foundation for QCD color confinement. 
          ...
          <div className="space-y-4">
            ...
            <div className="mt-6 p-4 bg-amber-50 rounded-lg">
              ...
              <p className="text-sm text-amber-700">
                The SKB hypothesis successfully predicts the complete quark spectrum, their charges, 
