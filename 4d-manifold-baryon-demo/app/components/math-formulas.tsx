    ...
    <div className="space-y-6">
      ...
      <Card className="scientific-panel">
        <CardHeader>
          ...
          <CardDescription>
            Core equations governing 4D Manifold baryon formation and properties
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-slate-700 leading-relaxed">
            The 4D Manifold hypothesis uses advanced topological mathematics to describe particle formation. 
        ...
        <Card className="scientific-panel">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              QCD Integration via 4D Manifold Hypothesis
            </CardTitle>
            <CardDescription>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-green-50 p-3 rounded">
                ...
                <p className="text-sm text-green-700">
                  The 4D Manifold hypothesis provides a geometric foundation for QCD phenomena: 
      ...
      <Card className="scientific-panel">
        <CardHeader>
          ...
          <CardDescription>
            How 4D Manifolds maintain external causality despite internal CTCs
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
